...
function NewSales() {
  ...
  return (
    <div className="flex gap-5 bg-gray-100 min-h-screen items-start">
      <div className="flex-1 w-2/3 rounded-lg flex flex-col">
        ...
        <div className="flex gap-4 mb-5 items-center">
          ...
          <button
            ...
            className="custom-blue-bottom text-white font-medium rounded-lg px-5 py-2 w-40 flex items-center gap-2 justify-center hover:bg-blue-900 transition-colors duration-150 cursor-pointer"
          >
                ...
                >
                  ...
                  <td className="p-3">
                    <button
                      ...
                      className="custom-blue-bottom text-white border-none rounded-full w-8 h-8 cursor-pointer flex items-center justify-center hover:bg-blue-900"
                    >
      ...
      <div className="w-1/3 bg-white rounded-lg p-5 h-full">
          ...
          <>
            ...
            <div className="flex gap-2.5 mt-4">
              ...
              <button
                ...
                className="flex-[2] p-3 custom-blue-bottom text-white hover:bg-blue-900 font-medium rounded-lg px-5 py-2 w-32 cursor-pointer flex items-center justify-center gap-2 transition-colors duration-150"
              >
