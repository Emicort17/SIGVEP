...
const menu = [
    { label: 'Inicio', path: '/', icon: House, iconActive: HouseActive },
    { label: 'Perfil', path: '/profile', icon: Person, iconActive: PersonActive },
    { label: 'Usuarios', path: '/users', icon: Users, iconActive: UsersActive },
    { label: 'Categorías', path: '/categories', icon: Category, iconActive: CategoryActive },
    { label: 'Productos', path: '/products', icon: Products, iconActive: ProductsActive },
    { label: 'Ventas', path: '/sales', icon: Sale, iconActive: SaleActive },
    { label: 'Bitácora', path: '/log', icon: Binnacle, iconActive: BinnacleActive },
]
