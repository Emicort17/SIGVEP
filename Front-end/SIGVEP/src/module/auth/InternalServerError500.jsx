  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center relative">
      ...
      <div className="flex flex-col items-center justify-center text-center z-10 w-full px-4 pb-16">
        ...
        <h1 className="text-6xl md:text-9xl font-bold text-white mb-2 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">500</h1>
        <h2 className="text-2xl md:text-4xl font-semibold text-white mb-4 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">Error Interno del Servidor</h2>
