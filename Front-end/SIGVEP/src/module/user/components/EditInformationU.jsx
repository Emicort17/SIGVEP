...
function EditInformationU({ isOpen, onClose, datosPersonales, onSuccess }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      const confirmed = await alertaPregunta("¿Deseas guardar los cambios?", "Esta acción actualizará tu información.");
      if (!confirmed) return;
      alertaCargando("Guardando información...", "Por favor, espere");
      try {
        const response = await AxiosClient.put(`/usuarios/${datosPersonales.id}`,
          {
        ...
        if (datosPersonales.email !== values.email) {
          alertaExito("Éxito", "Por favor, vuelve a iniciar sesión con tu nuevo correo electrónico.");
...
export default EditInformationU;